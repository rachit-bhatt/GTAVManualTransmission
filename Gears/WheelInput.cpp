...
void checkCameraButtons() {
    ...
    bool rightIn = g_controls.ButtonIn(CarControls::WheelControlType::LookRightMirror) ||
    ...
    bool rightJustPressed = g_controls.ButtonJustPressed(CarControls::WheelControlType::LookRightMirror) ||
                            g_controls.ButtonJustPressed(CarControls::WheelControlType::LookRight) ||
                            g_controls.ButtonJustPressed(CarControls::WheelControlType::LookRightBlindSpot);

    // who was first? If right held and left just pressed => toggle shoulder preference
    if (rightIn && leftJustPressed) {
        g_peripherals.LookBackRShoulder = true;
    }
    // If left held and right just pressed => toggle shoulder preference opposite
    if (leftIn && rightJustPressed) {
    ...
    else if (g_controls.ButtonIn(CarControls::WheelControlType::LookLeftMirror)) {
    ...
    else if (g_controls.ButtonIn(CarControls::WheelControlType::LookLeftBlindSpot)) {
        PAD::SET_CONTROL_VALUE_NEXT_FRAME(0, ControlVehicleLookBehind, 1.0f); // Looking behind first.
        CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(-45.0f);
    }
    else if (g_controls.ButtonIn(CarControls::WheelControlType::LookLeftBlindSpotPeak)) {
        CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0.0f, 1.0f);
        CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(135.0f);
    }
    else if (g_controls.ButtonIn(CarControls::WheelControlType::LookRightMirror)) {
        CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0.0f, 1.0f);
        CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(-45.0f);
    }
    ...
    else if (g_controls.ButtonIn(CarControls::WheelControlType::LookRightBlindSpot)) {
        CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0.0f, 1.0f);
        CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(-135.0f);
    }
    ...
    bool rightReleased = g_controls.ButtonReleased(CarControls::WheelControlType::LookRightMirror) ||
                         g_controls.ButtonReleased(CarControls::WheelControlType::LookRight) ||
                         g_controls.ButtonReleased(CarControls::WheelControlType::LookRightBlindSpot);
